...
typedef struct Texture {
  ...
  AABB aabb;
  GraphicsRender
      *ui_render; // Render is generic enough that it'll work for either
                  // rendering type. it's just an ebo and vbo, nothing
                  // special. it doesn't inherently make any assumptions
                  // about the shape of the vertices going into the Render,
                  // or the underlying shader context.
